...
Project Work:
*[Updated Branch Prediction](https://github.com/NYU-Processor-Design/nyu-core/pull/55): Updated the complex functionality document for the Branch Prediction Module with additional sub-headings, the branch_taken output, and branch_occr input.
