...
Project Work:
* [Parameterized ALU and Sign Extension Modules](https://github.com/NYU-Processor-Design/nyu-core/pull/4): Updated the ALU and Sign Extension Modules with parameterization for the wordsize.
...
* [https://github.com/NYU-Processor-Design/nyu-core/actions/runs/4746797089](https://github.com/NYU-Processor-Design/nyu-core/actions/runs/4746797089): Updated the CPU block diagram with the updated input and output names for the modules.
...
This week was also the first of what I hope to make weekly checkins about team members' assigned tasks. Currently. Uma is working on the CPU General Purpose Registers, Rielle is working on the Branch Address Calculator, and I'm workiong on the ID/EX Latch. Uma and Rielle are also both working on documentation for the repo which has been very helpful.