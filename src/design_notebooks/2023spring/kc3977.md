...
* [Design Notebook]([link to PR](https://github.com/NYU-Processor-Design/nyu-processor-design.github.io/pull/45)) Updated the design notebook, minor formatting changes
