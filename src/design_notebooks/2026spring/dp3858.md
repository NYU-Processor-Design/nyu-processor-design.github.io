...
- Attended the teammate meeting from 1–2 PM on Thursday.
- Fixed numerous git issues. 
- Resolved an issue with navigating across directors on this particular fork when cloned on a local device.  
