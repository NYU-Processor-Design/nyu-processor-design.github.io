...
| Team Lead      | Hans Yang      | <hans.yang@nyu.edu> | By Appointment |
| Team Lead      | Paul Gutierrez | <psg7350@nyu.edu>   | By Appointment |
...
***For the Processor Design team:*** Applicants should have completed CS-UY 2214 or CS/ECE-UY 2204 or have equivalent experience with RTL design. Team participation assumes familiarity with Verilog and associated tooling.
...
The team has a special focus on modularity of design, toolchain implementation, continuous integration, testing and verification, test coverage reporting, and module packaging. Team members should expect to develop familiarity with all of these areas prior to developing a specialization.
...
- Verilator/SystemC verification
- RISC-V ISA and CPU architecture
- Memory-mapped peripherals and interconnects
- FPGA prototyping
- Hardware debugging and integration
- ASIC/MPW design flow
- Technical documentation and team development
...
- **2 credits:** 8 hours per week[^1]
- **3 credits:** 12 hours per week[^2]
...
**The NYU Processor Design team** coordinates via GitHub issues, pull request comments, and Discord.

### VIP Notebook

Every VIP student maintains documentation consisting of meeting notes, details about their work and progress, lists of responsibilities, tasks, deadlines, reflections, etc.
...
VIP Notebook entries are expected to be updated weekly through PRs by Monday night. Notebook entries will be graded out of 2 points:
...
Students are granted up to two unexcused late PRs before penalties on their *Documentation* grade. For each week a submission is late, there will be a 1-point deduction from that week's entry.
...
Typically, students will present at the end of the semester on the work that they have completed during the semester. Further details regarding the presentation will be given toward the end of the semester.
