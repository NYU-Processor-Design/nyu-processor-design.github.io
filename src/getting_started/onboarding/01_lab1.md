# Lab 1: Git, GitHub, Design Notebook, and First RTL

\- Made by Hans :)

## Overview

Due date: 11:59PM 09/21/26 via design notebook.
...
1. Set up your Linux development environment with Git and Verilator.
...
You need a Linux environment for development in this VIP.
...
Once you set up your Linux environment, install Git and Verilator:
...
For your **design notebook pull requests**, use the title:
...
This first PR can simply create your notebook file. A lead will review and merge it.
...
If any of this is unclear, please review the Git guide or ask a lead/experienced member before continuing.
...
Verilator (our SystemVerilog simulator) will generate `obj_dir/` during compilation. These generated files should not be committed.
...
If this module confuses you, stop and review the code or ask a lead/member before continuing.
...
Follow the existing [Design Notebooks and Git Guide](../notebooks/00_toc.md) to update your Fall 2026 notebook under:
...
Submit the design notebook PR according to the existing guide. A VIP lead will review and merge it.
...
After you complete this lab, you may work on the next ones in order ahead of time. However, remember a design notebook entry is required every week regardless of lab completion.
