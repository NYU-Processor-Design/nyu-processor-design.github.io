# Previous Onboarding Labs

These onboarding labs were made by Noah (an awesome previous lead) and used in previous semesters and are preserved for reference.

They are no longer the current Processor Design VIP onboarding curriculum.
