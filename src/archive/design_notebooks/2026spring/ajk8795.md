...
# weeks 10-12 04/12-05/03/2026
- all labs were completed at this point
- there wasnt any work to do beyond coming up with the project proposal so just one notebook entry for this period.
- I spent some time researching potential project ideas and discussing them with my team
- we went back and forth on ideas and decided on a systolic array nn accelerator for radar signal processing and classification
- we did a lot of research into existing ideas and planned out the project
- our researhc and planning can be accessed at [https://github.com/tonykorycki/radar-systolic-asic](https://github.com/tonykorycki/radar-systolic-asic)
- we made a presentation pitch and presented to the group (in docs/proposal in the repo above)